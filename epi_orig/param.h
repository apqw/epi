...
#define NN 30000  // max #cells
#define N2 400 // used in lj[1..NN][1..N2], wj
#define N3 200 // area
...
#define para_kf 8.1
#define para_kp 0.2
#define para_kmu 0.05
#define mu0 0.567
#define mu1 0.1
#define CA_OUT 1.0
#define beta (CA_OUT*beta_zero)
...
#define para_Kgra para_kpa
#define para_Kpri 6. //para_kpa * 10.
#define para_H0 0.5
#define para_kpp 0.3

#define eps_w 0.001

#define delta_K 1.0//0.1  //0.1
#define delta_I 1.5//0.15 //0.01
...
#define THRESH_DEAD 22.0
#define DUR_DEAD 2.0
#define DUR_ALIVE 0.5
#define SIGMA_DEAD 0.05
#define SIGMA_ALIVE 0.01

#define STIM11 0.002
	
#define THRESH_SP 3.0 //7.0 // 9.0 // age of stratum spinosum ( a.k.a. T_pri)
...
extern double Da ;// 1.;
extern double du ;// 0.03;
extern double dp ;// 0.9;
